...
A1. このアプリは、俳句を保存し、管理するためのツールです。縦書きでの表示、詳細な検索機能、手書き入力など、多くの便利な機能が用意されています。
...
A5. 画面下部のメニューにある「検索・並び替え・絞り込み」アイコンをタップし、指示に従ってください。

Q6. 手書き入力はどうやって使いますか？

A6. 「手書き入力」アイコンをタップすると、手書きでの俳句の入力や編集ができます。Apple Pencilや指でも操作できます。
