...
お気に入りの俳句を登録保存して、句の日々の暗唱　や　評価の星をつけるなどして、将来の句集作成に役立てば幸いです
...
俳句を作らない方の場合、作者名は覚書に入力か　下の句に続けて空白を入れて作者名を入力していただいても。

**


<a id="a1"></a> 
##よくある質問　Q & A　　　　<a id="A1"></a>　　　 [詳しい説明は、こちら](#詳しい説明)


Q1. このアプリは何ができますか？　　[A1へ](#A1)

Q2. どうやって俳句を追加しますか？　　[A2へ](#A2)

Q3. 登録した俳句の並び順を変更できますか？　　[A3へ](#A3)

Q4. 登録した内容を外部にできますか？　　[A4へ](#A4)

Q5. 友達と共有やフォトライブラリへの保存は可能ですか？　　[A5へ](#A5)

Q6. 検索・並び替え・絞り込み方法は？　　[A6へ](#A6)

Q7. 手書き入力はどうやって使いますか？　　[A7へ](#A7)

Q8. 句会休会のときの欠席投句にこのアプリは使えますか？　　[A8へ](#A8)

Q9. 登録した句は削除できますか？　　[A9へ](#A9)

Q10. 登録した内容を変更できますか？　　[A10へ](#A10)

Q11. 俳句の評価を星の数でするには？　　[A11へ](#A11)

Q12. 俳句の作りませんが、このアプリで楽しめますか？　　[A12へ](#A12)
...
Q4. 登録した内容を外部に保存はできますか？   <a id="A4"></a>
...
Q5. 友達と共有やフォトライブラリへの保存は可能ですか？   <a id="A5"></a>
...
Q6. 検索・並び替え・絞り込み絞り込み方法は？　   <a id="A6"></a>
...
Q7. 手書き入力はどうやって使いますか？　   <a id="A7"></a>

A7. 画面下部にある「手書入力」をタップすると、手書きでの俳句の入力や編集ができます。

　　Apple Pencilや指で手書きや写真アプリから画像を取込みできます。
  
　　「手書きツール」を押すと、下から、ツールが出てきます。
  
  　「画像取込み」を押すと、写真アプリが表示され、選択すると、手書入力画面に取り込まれます
   
    「スクリーンショット保存」を押すと、写真アプリの写真にスクショが保存され　＆アルバム「俳句　D&E」にも入ります。

　 「手書き消去」を押すと、　入力した手書きを全て消去します。
...
*
 ...
 Q12. 俳句の作りませんが、このアプリで楽しめますか？　   <a id="A12"></a>
...
Apple Pencilや指を使っての手書きのメモができます。
 ...
 画面下部にある「手書入力」をタップすると、手書きでの俳句の入力や編集ができます。
