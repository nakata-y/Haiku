...
このアプリは、あなたのお気に入りの俳句を保存して、いつでも楽しめるアプリです。
縦書きでの表示や手書き入力など、色々な機能をお楽しみください。

俳句を作らない方も、好きな俳句を保存してお楽しみください。
...
A1. 俳句を保存したり、縦書きで短冊風・色紙風で見たり、検索・並び替え・手書き入力がきます。
...
　　また、メイン画面で俳句をタップすると、その俳句が表示され、
  　右上のカメラマークをタップすると、フォトライブラリへの保存も可能です。
...
あなたの大切でお気に入りの俳句を登録保存して、将来の句集作成にも役立てば幸いです。

＊ 縦書きで保存した俳句の一覧表示されます。短冊に書いたように。
