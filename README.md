...
また、ご自分で俳句を作らない方は、お好きな俳句を登録して、覚書に作者名を入力するなどして、楽しんでください。
...
　　　俳句だけの保存なら、メイン画面の右上の共有ボタンで、保存すれば安心です。
   　俳句以外の覚書等も保存したいときは、検索・並び替え・絞り込み　のページ（Q６参照）の右上に共有ボタンで、保存すれば安心です。
  
Q5. 共有やフォトライブラリへの保存は可能ですか？

A5. はい、メイン画面や検索・並び替え・絞り込み　のページ（Q５参照）の右上に共有ボタンがあり、
　　　他のユーザーと簡単に共有できます。
...
Q6. 検索・並び替え・絞り込みはどう操作するの？

A6. 画面下部にある「検索・並び替え・絞り込み」アイコンをタップしてください。

Q7. 手書き入力はどうやって使いますか？

A7. 画面下部にある「手書き入力」アイコンをタップすると、手書きでの俳句の入力や編集ができます。
