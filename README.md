...
それぞれの画面について以下の説明を参照ください。</details>
...
<details>
<summary>Q 　ヘルプページへの簡単なアクセス。「？」ボタン。　</summary>　
 「メイン画面」の右上の「？」ボタンをタップすれば、このページに飛びます。
わからなくなったら、「？」ボタンをタップください。
</details>
...
A  このアプリは、自分で作った俳句を登録するために作ったので、作者名の入力欄はありません。
ただ、＝にいただければ、短冊に、　＝ににゅう
</details>
