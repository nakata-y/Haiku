...
　　　　　[Q & A はこちら　](#a1)      
     ...
     (GithubアプリをiPhone/iPadにインストールなさってる方で、表示に不具合がある場合は、
    こちらを　 [https://github.com/nakata-y/Haiku/blob/main/README.md#アプリの説明](https://github.com/nakata-y/Haiku/blob/main/README.md#アプリの説明
) クリックください)
